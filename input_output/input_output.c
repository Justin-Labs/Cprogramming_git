...
int main()
{
    ...
    printf("----------------\n");
    //the format specifier lf is for double, since is basically a long float
    //if we used a Lf is long double which is an even bigger data type.
    printf("Let's print a double: %.1lf\n", 23.909e27);
